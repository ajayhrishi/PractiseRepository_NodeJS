...
const tempMainPage = fs.readFileSync('./starter/templates/overview.html', 'utf-8'); // template to load the main page
const tempCard = fs.readFileSync('./starter/templates/template-card.html', 'utf-8'); //template to load the card inside the main page, . 
const tempProdcut = fs.readFileSync('./starter/templates/template-product.html', 'utf-8'); //template to load the product page. 
const data = fs.readFileSync('./starter/dev-data/data.json', 'utf-8');// this methoad will read the content inside the data.json as a string. 
